...
**A Solução:** Desenvolvi uma "Landing Page" centralizadora, com interface intuitiva e responsiva, que serve como um hub para todos os formulários da empresa. Agora, o colaborador precisa memorizar apenas um único link para acessar qualquer processo.

---

## 🛠️ Tecnologias Utilizadas
* **HTML5**: Estruturação semântica da página.
* **CSS3**: Estilização moderna utilizando **Flexbox** para garantir que a página seja responsiva (funcione em PCs e Celulares).
* **Git & GitHub**: Controle de versão e hospedagem via GitHub Pages.

---

## 💡 Funcionalidades
- [x] **Hub Centralizado**: 10 botões de acesso rápido aos principais processos.
